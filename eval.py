...
parser.add_argument("--eval_h_pred_and_rec", type=int, help="True/False ; Evaluating the h-predictions and reconstructions, or not.")
args = parser.parse_args()

eval_h_pred_and_rec = bool(args.eval_h_pred_and_rec)
...
if __name__ == "__main__":
    ...
    if eval_h_pred_and_rec:
        ...
        try:
            ...
            print('No ground truth for h values available. To generate it, run the full preprocessing script.')
            print('Going on without evaluating h-predictions and reconstructions (only counting performance).')
            eval_h_pred_and_rec = False
    ...
    if eval_h_pred_and_rec:
        ...
        d = {'image_id':im_ids, 'true_count':true_counts, 'estim_count':estim_counts, 'true_h':true_h_vals, 'estim_h': estim_h_vals, 'mse_rec': rec_errors}
    else:
        d = {'image_id':im_ids, 'true_count':true_counts, 'estim_count':estim_counts}
